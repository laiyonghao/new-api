(function () {
  ...
  function normalizeCompareSelection(values, limit) {
    ...
    (values || []).forEach(function (value) {
      if (!STATION_NAMES[value] || normalized.indexOf(value) !== -1) return;
        ...
        <div class="argus-dialog-backdrop" data-dialog="site-editor" aria-hidden="true">
          <section class="argus-dialog argus-dialog-lg" role="dialog" aria-modal="true" aria-labelledby="site-editor-title">
            ...
            <div class="argus-dialog-body">
              <form class="grid gap-5" data-static-form="#site-editor-success">
      ...
      ensureDialogMarkup('login', `
        <div class="argus-dialog-backdrop" data-dialog="login" aria-hidden="true">
          <section class="argus-dialog" role="dialog" aria-modal="true" aria-labelledby="login-dialog-title">
            ...
            <div class="argus-dialog-body">
              <form class="space-y-5" data-static-form="#login-success">
                <div class="grid gap-3 sm:grid-cols-[1fr_auto] sm:items-end">
                  <div class="argus-field"><label for="login-email">邮箱地址</label><input id="login-email" data-login-email-input class="argus-input" type="email" value="hello@example.com"></div>
                  <button class="argus-btn argus-btn-secondary min-h-[56px] rounded-[16px]" type="button" data-reveal-target="#login-code-sent">发送验证码</button>
                </div>
